...
try
{
	...
	String q3 = "create table cart(email varchar(100), product_id int, quantity int, price int, total int, address varchar(500), city varchar(100), state varchar(100), country varchar(100), mobileNumber varchar(15), orderDate varchar(100),deliveryDate varchar(100), paymentMethod varchar(100), transectionId varchar(100), status varchar(10))";
	...
	st.execute(q3);
	st.execute(q4);
	System.out.println("table cerated");
	con.close();
}
catch(Exception e)
{
